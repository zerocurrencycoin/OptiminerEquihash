...
USAGE: 
   ...
   ./optiminer-equihash  [--pci-mode <0-3>] [--benchmark <seconds>]
                         [--list-devices] [--force-generic-kernel]
                         [--experimental-kernel] [--nodevfee] [-i <number>]
                         ...  [-m <port>] [--watchdog-cmd <command>]
                         [--watchdog-timeout <seconds>] [--max-log-files
                         <count>] [--max-log-file-size <bytes>] [-l
                         <filename>] [-v] [-p <string>] [-u <string>] [-s
                         <host:port>] [-d <integer>] ...  [-c <integer>]
                         [-a <name>] [--] [--version] [-h]
